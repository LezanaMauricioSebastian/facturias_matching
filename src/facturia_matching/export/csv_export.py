...
from facturia_matching.core.amounts import csv_export_cell, rows_prepared_for_odoo_csv
from facturia_matching.core.constants import CSV_EXPORT_TAX_IDS_HEADER, csv_export_headers, output_headers_for_profile
...
def build_csv_response(rows: List[Dict[str, Any]]) -> StreamingResponse:
    ...
    base_headers = output_headers_for_profile()
