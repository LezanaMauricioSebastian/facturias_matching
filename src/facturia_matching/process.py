...
from facturia_matching.config import DEFAULT_JOURNAL_NAME, DEFAULT_RUBRO_NAME
from facturia_matching.constants import IVA_SPECIAL_OPTIONS
from facturia_matching.odoo_catalog import (
    get_catalog,
    resolve_account_id,
    resolve_doc_type_id,
    resolve_id_fuzzy,
...
from facturia_matching.padron import match_proveedor
from facturia_matching.padron_taxes import (
    PadronTaxMatchCache,
    apply_padron_taxes_to_row,
    get_tax_name_by_id,
)
from facturia_matching.purchase_matching import enrich_rows_with_purchase_data
from facturia_matching.utils import doc_type_label, normalize, normalize_date_ddmmyyyy
...
def parse_process_json(
    ...
    for fac_wrap in facturas:
        ...
        nro = normalize(fac.get("numero_factura"))
