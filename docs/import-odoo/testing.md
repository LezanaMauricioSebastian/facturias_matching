...
| Aprendizaje producto (tabla `product_label_memory`) | `test_product_label_memory_*`, `test_match_invoice_row_prefers_learned_over_fuzzy`, `test_match_invoice_row_oc_beats_learned`, `test_upsert_*` | [purchase-oc.md](purchase-oc.md#aprendizaje-de-producto-procesos-pasados) |
