...
| Montos otros impuestos en multi-línea | `always shows otros impuestos monto columns in multi-line` en `tests/js/solo_encabezado.test.mjs` | [guia-usuario.md](../guia-usuario.md) |
